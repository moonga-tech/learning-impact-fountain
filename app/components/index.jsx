        ...
        <>
            <div className="banner">
                <h1 className="text-5xl font-bold">
                    <span className="text-white space-x-1">Welcome to Learning Impact Foundation (LIF)</span>
                </h1>
                ...
                <button className="bg-orange-400 rounded btn" onClick={getStarted}>
                    <Icon name="arrow" className="inline-block mr-3" /> Get Started
                </button>
            </div>

            <section id="about-us">
                <h1 className="text-center text-2xl font-bold"><i className="fa-solid fa-circle-info"></i> About Us</h1>
                <p>
            ...
            <section className="mission-vision w-full flex flex-column bg-gray-800 text-gray-200 px-4 py-10">
                <div className="our-mission flex flex-row-reverse justify-around flex-wrap mb-10 gap-8" id="our-mission">
                    <div className="text flex flex-col justify-center w-full md:w-1/2">
                        <h1 className="text-center md:text-left text-2xl font-bold">Our Mission</h1>
                        <p>
                ...
                <div className="our-vision flex flex-row justify-around flex-wrap gap-8" id="our-vision">
                    <div className="text flex flex-col justify-center w-full md:w-1/2">
                        <h1 className="text-center md:text-left text-2xl font-bold">Our Vision</h1>
                        <p>
            ...
            <section className="py-4">
                <h1 className="text-center text-2xl font-bold"><i className="fa-solid fa-lightbulb "></i> Why We Exist</h1>
                <p>
            ...
            <section id="our-core-values">
                <h1 className="text-center text-2xl font-bold">Our Core Values</h1>
                <ol>
            ...
            <section className="join-us text-center m-auto">
                ...
                <button className="btn mt-5 bg-orange-400 text-white" onClick={joinUs}>Join Us</button>
            </section>
        </>
    )
}